...
* 사용 가능한 기능:
+
** ONTAP 9.12.1부터 NVMe/TCP에 대한 보안 인밴드 인증이 지원됩니다. Oracle Linux 9.4에서는 NVMe/TCP에 대해 안전한 인밴드 인증을 사용할 수 있습니다.
...
ONTAP 9.12.1부터 Oracle Linux 9.4 호스트와 ONTAP 컨트롤러 간의 NVMe/TCP를 통한 안전한 인밴드 인증이 지원됩니다.
