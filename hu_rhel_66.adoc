...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=852674["1076584"^] | RHEL 6U4에서 저장소 장애 시 QLogic 16G FC(QLE2672) 호스트에서 최대 300초의 I/O 중지 | 스토리지/Fabric 장애 시 QLogic 16G FC(QLE2672) 호스트에서 최대 300초의 I/O 스톨이 관찰될 수 있습니다. 
