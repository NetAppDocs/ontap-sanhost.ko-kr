...
summary: 호스트 유틸리티 툴을 사용하여 NetApp 스토리지 구성의 엔드 투 엔드 검증을 위해 AIX 호스트 유틸리티 샘플 명령 참조를 사용할 수 있습니다. 
---
...
[role="lead"]
호스트 유틸리티 툴을 사용하여 NetApp 스토리지 구성의 엔드 투 엔드 검증을 위해 AIX 호스트 유틸리티 샘플 명령 참조를 사용할 수 있습니다.
