...
NOTE: Oracle Linux 7.6 RHCK(Red Hat Enterprise Kernel)를 구성하려면 RHEL(Red Hat Enterprise Linux) 7.6용 을 link:hu_rhel_76.html#recommended-settings["권장 설정"]사용하십시오.
