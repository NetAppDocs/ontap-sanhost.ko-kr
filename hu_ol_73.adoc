...
NOTE: Oracle Linux 7.3 RHCK(Red Hat Enterprise Kernel)를 구성하려면 RHEL(Red Hat Enterprise Linux) 7.3용 을 link:hu_rhel_73.html#recommended-settings["권장 설정"]사용하십시오.
