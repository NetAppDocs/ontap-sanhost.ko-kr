...
summary: ONTAP에서 Oracle Linux 8.10을 사용하는 방법에 대해 설명합니다 
---
...
NOTE: Oracle Linux 8.10 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 8.10용 을 link:hu_rhel_810.html#recommended-settings["권장 설정"]사용하십시오.
...
Oracle Linux 8.10과 ONTAP 릴리스의 경우 알려진 문제가 없습니다.
