...
NOTE: Oracle Linux 7.2 RHCK(Red Hat Enterprise Kernel)를 구성하려면 RHEL(Red Hat Enterprise Linux) 7.2용 을 link:hu_rhel_72.html#recommended-settings["권장 설정"]사용하십시오.
