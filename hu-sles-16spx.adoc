...
summary: SUSE Linux Enterprise Server 16에 Linux Host Utilities를 설치하여 ONTAP LUN을 사용한 FCP 및 iSCSI 프로토콜 작업을 관리하십시오. 
---
= ONTAP 스토리지를 사용하여 FCP 및 iSCSI를 지원하도록 SUSE Linux Enterprise Server 16을 구성합니다.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Linux Host Utilities 소프트웨어는 ONTAP 스토리지에 연결된 Linux 호스트를 위한 관리 및 진단 도구를 제공합니다. SUSE Linux Enterprise Server 16 호스트에 Linux Host Utilities를 설치하면 Host Utilities를 사용하여 ONTAP LUN으로 FCP 및 iSCSI 프로토콜 작업을 관리하는 데 도움을 받을 수 있습니다.
...
SUSE Linux Enterprise Server 16에서 멀티패싱을 사용하여 ONTAP LUN을 관리할 수 있습니다.
