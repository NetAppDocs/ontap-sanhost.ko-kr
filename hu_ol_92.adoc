...
NOTE: Oracle Linux 9.2 RedHat Enterprise Kernel(RHCK)을 구성하려면 를 사용하십시오 link:hu_rhel_91.html#recommended-settings["권장 설정"] RHEL(Red Hat Enterprise Linux) 9.2의 경우
