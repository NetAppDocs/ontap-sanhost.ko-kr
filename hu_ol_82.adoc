...
NOTE: Oracle Linux 8.2 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 8.2용 을 link:hu_rhel_82.html#recommended-settings["권장 설정"]사용하십시오.
...
NOTE: Oracle Linux RHCK의 알려진 문제는 RHEL 8.2용 을 참조하십시오link:hu_rhel_82.html#known-problems-and-limitations["알려진 문제"].
