...
---
= ONTAP와 함께 Red Hat Enterprise Linux 8.5를 사용하십시오
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP가 있는 Red Hat Enterprise Linux 8.5를 대상으로 구성할 수 있습니다.
...
ONTAP 릴리스가 포함된 RHEL 8.5에는 알려진 문제가 없습니다.
