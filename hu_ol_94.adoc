...
NOTE: Oracle Linux 9.4 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 9.4용 을 link:hu_rhel_94.html#recommended-settings["권장 설정"]사용하십시오.
