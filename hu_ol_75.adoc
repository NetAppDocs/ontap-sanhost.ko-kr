...
NOTE: Oracle Linux 7.5 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 7.5용 을 link:hu_rhel_75.html#recommended-settings["권장 설정"]사용하십시오.
...
ONTAP 릴리즈가 포함된 Oracle Linux 7.5에는 다음과 같은 알려진 문제가 있습니다.
