...
---
= NetApp ONTAP 기반의 Red Hat Enterprise Linux 9.1 사용
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NetApp에서는 Linux Unified Host Utilities를 설치하는 것을 적극 권장하지만 반드시 설치할 필요는 없습니다. 유틸리티는 Linux 호스트의 설정을 변경하지 않습니다. 유틸리티를 사용하면 관리를 개선하고 NetApp 고객 지원 이 귀사의 구성 정보를 수집할 수 있도록 지원합니다.
