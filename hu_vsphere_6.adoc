...
을 참조하십시오 https://["NetApp 상호 운용성 매트릭스 툴"^] 특정 버전의 ONTAP 툴 또는 특정 버전의 vSphere 및 ONTAP를 위한 기존 VASA Provider에 대한 자세한 지원

VVOL 프로비저닝 및 관리에 대한 자세한 내용은 VMware vSphere용 ONTAP 툴 설명서도 참조하십시오 https://["TR-4597"^] 및 link:https://www.netapp.com/pdf.html?item=/media/13555-tr4400pdf.pdf["TR-4400"^]
...
NOTE: UNMAP을 작동하기 위해 VMware vSphere에 매핑된 모든 LUN에 대해 공간 할당 설정을 활성화합니다. 자세한 내용은 을 참조하십시오 https://["ONTAP 문서"^].
