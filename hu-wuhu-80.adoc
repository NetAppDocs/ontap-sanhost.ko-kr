...
. 실행 파일을 다운로드하세요 https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/8.0/downloads["NetApp Support 사이트"^] .
. 실행 파일을 다운로드한 디렉터리로 변경합니다.
. 실행하다 `netapp_windows_host_utilities_8.0.0_x64` 파일을 선택하고 화면의 지시를 따르세요.
