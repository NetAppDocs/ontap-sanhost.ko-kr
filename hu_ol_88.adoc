...
NOTE: Oracle Linux 8.8 RedHat Enterprise Kernel을 구성하려면 를 사용하십시오 link:hu_rhel_88.html#recommended-settings["권장 설정"] RHEL(Red Hat Enterprise Linux) 8.8의 경우
...
Oracle Linux 8.8 및 ONTAP 릴리스에는 알려진 문제가 없습니다.
