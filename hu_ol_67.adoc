...
---
= Oracle Linux 6.7과 NetApp ONTAP 사용
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Oracle Linux 6.7 RedHat Enterprise Kernel(RHCK)을 구성하려면 를 사용합니다 link:hu_rhel_67.html#recommended-settings["권장 설정"] Red Hat Enterprise Linux(RHEL) 6.7의 경우



== 알려진 문제 및 제한 사항

Oracle 6.7에는 알려진 문제가 없습니다.
