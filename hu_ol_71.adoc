...
NOTE: Oracle Linux 7.1 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_71.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 7.1용 을 사용하십시오.
