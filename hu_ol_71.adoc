...
---
= NetApp ONTAP와 함께 Oracle Linux 7.1 사용
:toc: macro
:hardbreaks:
:toclevels: 1
:toc: 
...
Oracle Linux 7.1에는 알려진 문제가 없습니다.


NOTE: Oracle Linux(Red Hat 호환 커널) 알려진 문제에 대해서는 을 참조하십시오 link:hu_rhel_71.html#known-problems-and-limitations["알려진 문제"] Red Hat Enterprise Linux(RHEL) 7.1의 경우
