...
NOTE: Oracle Linux 7.7 RHCK(Red Hat Enterprise Kernel)를 구성하려면 RHEL(Red Hat Enterprise Linux) 7.7용 을 link:hu_rhel_77.html#recommended-settings["권장 설정"]사용하십시오.
