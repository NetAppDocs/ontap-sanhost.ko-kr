...
---
= ONTAP와 함께 Red Hat Enterprise Linux 6.9를 사용하십시오
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP를 대상으로 Red Hat Enterprise Linux 6.9를 구성할 수 있습니다.
...
RHEL 6.9 ONTAP 릴리스에는 다음과 같은 알려진 문제가 있습니다.
