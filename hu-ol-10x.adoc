...
summary: Oracle Linux 10.x 호스트에 Linux Host Utilities를 설치하여 ONTAP LUN으로 FCP 및 iSCSI 프로토콜 작업을 관리하십시오. 
---
= ONTAP 스토리지를 사용하여 FCP 및 iSCSI를 위한 Oracle Linux 10.x 구성
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Linux Host Utilities 소프트웨어는 ONTAP 스토리지에 연결된 Linux 호스트를 위한 관리 및 진단 도구를 제공합니다. Oracle Linux 10.x 호스트에 Linux Host Utilities를 설치하면 Host Utilities를 사용하여 ONTAP LUN에서 FCP 및 iSCSI 프로토콜 작업을 관리할 수 있습니다.
...
link:hu_luhu_71.html["ONTAP 스토리지용 Linux Host Utilities 7.1 설치"].
...
Oracle Linux 10.x에서 멀티패싱을 사용하여 ONTAP LUN을 관리할 수 있습니다.
