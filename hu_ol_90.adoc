...
NOTE: Oracle Linux 9.0 Red Hat Enterprise Kernel(RHCK)을 구성하려면 link:hu_rhel_86.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 9.0용 을 사용하십시오.
