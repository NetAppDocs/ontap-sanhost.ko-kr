...
NOTE: Oracle Linux 7.8 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 7.8용 을 link:hu_rhel_78.html#recommended-settings["권장 설정"]사용하십시오.
