...
---
= Oracle Linux 6.5와 NetApp ONTAP 사용
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Oracle Linux 6.5 RedHat Enterprise Kernel(RHCK)을 구성하려면 를 사용합니다 link:hu_rhel_65.html#recommended-settings["권장 설정"] Red Hat Enterprise Linux(RHEL) 6.5의 경우



== 알려진 문제 및 제한 사항

Oracle 6.5에는 알려진 문제가 없습니다.
