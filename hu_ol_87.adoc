...
NOTE: Oracle Linux 8.7 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_87.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 8.7용 을 사용하십시오.
