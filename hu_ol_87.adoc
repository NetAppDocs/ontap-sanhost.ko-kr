...
summary: ONTAP LUN을 사용하여 FCP 및 iSCSI 프로토콜 작업을 관리하기 위해 Oracle Linux 8.7 호스트에 Linux 호스트 유틸리티를 설치합니다. 
---
...
NOTE: 당신은 사용할 수 있습니다 link:hu_rhel_87.html#rhel-rhck["Red Hat Enterprise Linux(RHEL) 8.7에 권장되는 설정"] Oracle Linux 8.7에 대한 Red Hat 호환 커널을 구성하는 방법.
