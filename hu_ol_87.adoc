...
NOTE: Oracle Linux 8.7 RHCK(Red Hat Enterprise Kernel)를 구성하려면 RHEL(Red Hat Enterprise Linux) 8.7용 을 link:hu_rhel_87.html#recommended-settings["권장 설정"]사용하십시오.
...
Oracle Linux 8.7과 ONTAP 릴리스의 경우 알려진 문제가 없습니다.
