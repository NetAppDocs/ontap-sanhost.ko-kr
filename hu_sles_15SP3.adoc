...
---
= ONTAP와 함께 SUSE Linux Enterprise Server 15 SP3을 사용합니다
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP가 포함된 SUSE Linux Enterprise Server 15 SP3을 대상으로 구성할 수 있습니다.
...
SUSE Linux Enterprise Server 15 SP3(ONTAP 릴리스 포함)에는 알려진 문제가 없습니다.
