...
---
= ONTAP와 함께 Oracle Linux 6.8을 사용합니다
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP를 대상으로 Oracle Linux 6.8을 구성할 수 있습니다.
...
NOTE: Oracle Linux 6.8 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_68.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 6.8용 을 사용하십시오.



== 알려진 문제

Oracle Linux 6.8과 ONTAP 릴리스에 대해서는 알려진 문제가 없습니다.
