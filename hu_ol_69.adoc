...
---
= Oracle Linux 6.9와 NetApp ONTAP 사용
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Oracle Linux 6.9 RedHat Enterprise Kernel(RHCK)을 구성하려면 를 사용합니다 link:hu_rhel_69.html#recommended-settings["권장 설정"] RHEL(Red Hat Enterprise Linux) 6.9의 경우
