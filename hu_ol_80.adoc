...
NOTE: Oracle Linux 8.0 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_80.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 8.0용 을 사용하십시오.



== 알려진 문제

ONTAP를 사용하는 Oracle Linux 8.0에는 알려진 문제가 없습니다.
