...
---
= ONTAP와 함께 Oracle Linux 8.1을 사용하십시오
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP를 대상으로 Oracle Linux 8.1을 구성할 수 있습니다.
...
NOTE: Oracle Linux 8.1 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_81.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 8.1용 을 사용하십시오.



== 알려진 문제

ONTAP가 설치된 Oracle Linux 8.1 릴리스에는 알려진 문제가 없습니다.
