...
.Marvell/QLogic
--
RHEL 9.0 커널에 포함된 기본 받은 편지함 qla2xxx 드라이버에는 ONTAP 지원에 필수적인 최신 수정 사항이 포함되어 있습니다.
