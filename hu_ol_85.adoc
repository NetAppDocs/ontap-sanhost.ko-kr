...
NOTE: Oracle Linux 8.5 RHCK(Red Hat Enterprise Kernel)을 구성하려면 link:hu_rhel_85.html#recommended-settings["권장 설정"]RHEL(Red Hat Enterprise Linux) 8.5용 을 사용하십시오.
...
Oracle Linux 8.5와 ONTAP 릴리즈에는 알려진 문제가 없습니다.
