...
NOTE: Oracle Linux 8.5 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 8.5용 을 link:hu_rhel_85.html#recommended-settings["권장 설정"]사용하십시오.
...
NOTE: Oracle Linux RHCK의 알려진 문제는 해당 RHEL 릴리스 설명서의 섹션을 참조하십시오link:hu_rhel_85.html#known-problems-and-limitations["알려진 문제"].
