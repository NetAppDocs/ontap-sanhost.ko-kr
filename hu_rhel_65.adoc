...
RHEL 6.5과 ONTAP 릴리스의 알려진 문제는 다음과 같습니다.
...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=760515["760515"^] | 스토리지 페일오버 작업 중에 RHEL 6.5 8G Qlogic FC SAN 호스트에서 경로 장애 또는 호스트 작동이 멈춤을 관찰했습니다 | 스토리지 페일오버 작업 중에 RHEL 6.5 8G Qlogic FC SAN 호스트에서 경로 장애 또는 호스트 작동이 멈춤을 관찰했습니다. 
...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=799394["799394"^] | RHEL 6U5: Emulex 16G FC(LPe16002B-M6) 호스트 충돌은 스토리지 페일오버 작업이 있는 I/O에서 관찰됩니다 | 스토리지 페일오버 작업이 수행되는 I/O 중에는 16G FC Emulex(LPe16002B-M6) 호스트 충돌이 표시됩니다. 
