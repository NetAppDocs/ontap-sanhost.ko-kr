...
---
= ONTAP와 함께 Red Hat Enterprise Linux 6.5를 사용하십시오
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP가 있는 Red Hat Enterprise Linux 6.5를 대상으로 구성할 수 있습니다.
...
RHEL 6.5 및 ONTAP 릴리스에는 다음과 같은 알려진 문제가 있습니다.
