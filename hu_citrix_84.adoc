...
summary: ONTAP 스토리지를 사용하여 FCP 및 iSCSI 프로토콜 작업을 위한 특정 매개변수와 설정을 사용하여 Citrix Hypervisor 8.4를 다중 경로로 구성합니다. 
---
...
[role="lead"]
ONTAP 스토리지를 사용하여 FCP 및 iSCSI 프로토콜 작업을 위한 특정 매개변수와 설정을 사용하여 Citrix Hypervisor 8.4를 다중 경로로 구성합니다.
...
Citrix Hypervisor 8.4에서 멀티패스를 사용하여 ONTAP LUN을 관리할 수 있습니다.
