...
NOTE: Oracle Linux 8.6 RHCK(link:hu_rhel_86.html#recommended-settings["권장 설정"]Red Hat Enterprise Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 8.6용 을 사용하십시오.
...
ONTAP 릴리즈를 사용하는 Oracle Linux 8.6에는 알려진 문제가 없습니다.
