...
NOTE: Oracle Linux 8.9 RHCK(Red Hat Compatible Kernel)을 구성하려면 RHEL(Red Hat Enterprise Linux) 8.9용 을 link:hu_rhel_89.html#recommended-settings["권장 설정"]사용하십시오.
