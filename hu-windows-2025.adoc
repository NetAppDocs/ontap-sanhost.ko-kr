...
---
= ONTAP 스토리지에 대해 Windows Server 2025를 구성합니다
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP SAN 호스트 구성 설정을 사용하여 ONTAP 스토리지와 함께 작동하도록 Windows Server 2025를 구성할 수 있습니다.
...
Windows 호스트에 스토리지 시스템에 대한 경로가 둘 이상인 경우 Microsoft MPIO(다중 경로 I/O) 소프트웨어를 설치하고 다중 경로를 활성화해야 합니다.
