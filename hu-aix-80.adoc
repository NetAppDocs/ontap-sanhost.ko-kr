...
--
====
. 로 가다 https://mysupport.netapp.com/site/products/all/details/hostutilities/downloads-tab/download/61343/8.0/downloads["NetApp Support 사이트"^] 호스트 유틸리티가 포함된 압축 파일을 호스트의 디렉토리에 다운로드합니다.
