...
summary: ONTAP 스토리지를 사용하여 FCP 및 iSCSI 작업을 위한 다중 경로 및 특정 매개변수와 설정을 사용하여 Ubuntu 20.04를 구성합니다. 
---
...
[role="lead"]
ONTAP 스토리지를 사용하여 FCP 및 iSCSI 작업을 위한 다중 경로 및 특정 매개변수와 설정을 사용하여 Ubuntu 20.04를 구성합니다.
