...
summary: ONTAP 스토리지를 사용하여 FCP 및 iSCSI 프로토콜 작업에 대한 특정 매개변수와 설정을 사용하여 다중 경로를 사용하도록 Ubuntu 20.04를 구성합니다. 
---
= ONTAP 스토리지를 사용하여 FCP 및 iSCSI를 위한 Ubuntu 20.04 구성
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
ONTAP 스토리지를 사용하여 FCP 및 iSCSI 프로토콜 작업에 대한 특정 매개변수와 설정을 사용하여 다중 경로를 사용하도록 Ubuntu 20.04를 구성합니다.
...
Ubuntu 20.04에서 멀티패스를 사용하여 ONTAP LUN을 관리할 수 있습니다.
